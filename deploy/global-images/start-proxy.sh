...
auth:
  ...
  timeoutMs: 5000
  # Bearer hacia auth/verify cuando el core tiene gateway key activa
  # (fix 4017f2c / PR #1211). Vacío = comportamiento legacy sin header.
  gatewayApiKey: "${MEMORY_CORE_GATEWAY_API_KEY}"
